...
local S = {
    ...
    -- 0号组：饰品&药水
    bg0Title            = { "饰品&药水",         "Trinkets & Potions" },
    bg0Enable           = { "启用饰品与药水BUFF监控组(0号组)", "Enable Trinkets & Potions Buff Group (Group 0)" },
    bg0AutoTrinkets     = { "自动检测装备的主动饰品", "Auto-detect Active Trinkets" },
    bg0AutoTrinketsHint = { "勾选后自动检测装备槽位13/14的主动饰品，自动添加到监控列表", "Auto-detect active trinkets in slots 13/14 and add to monitor list" },
    bg0PotionItems      = { "手动添加物品",      "Manual Items" },
    bg0AddItem          = { "添加物品",          "Add Item" },
    bg0PotionHint       = { "输入物品ID",        "Enter Item ID" },
    bg0CannotDelete     = { "0号组为系统组，无法删除", "Group 0 is a system group and cannot be deleted" },
    bg0ItemHint         = { "提示：此组基于物品ID监控，不依赖冷却管理器", "Note: This group monitors item IDs directly, independent of CDM" },
    bg0ShowPreview      = { "显示预览",          "Show Preview" },
    bg0HidePreview      = { "隐藏预览",          "Hide Preview" },
    bg0PreviewHint      = { "解锁后可看到组位置边框，点击「显示预览」可临时显示占位图标", "Unlock to see group border, click 'Show Preview' for placeholder icons" },
    bg0MonitorList      = { "监控物品列表",      "Monitored Items" },
    bg0AutoDetected     = { "(自动检测)",        "(Auto-detected)" },
    -- 编辑模式锁定提示
