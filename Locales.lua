...
local S = {
    ...
    -- 配置方案
    profileManage   = { "配置方案",         "Profiles" },
    profileDesc     = { "配置会自动保存，方案用于在角色间共享或备份。", "Config auto-saves. Profiles are for sharing between characters or backup." },
    profileSave     = { "保存为方案",       "Save as Profile" },
    profileSaveName = { "方案名称",         "Profile Name" },
    profileLoad     = { "加载方案",         "Load" },
    profileDelete   = { "删除",             "Delete" },
    profileDeleteConfirm = { "确认删除？",  "Confirm?" },
    profileSelect   = { "选择方案",         "Select Profile" },
    profileSaved    = { "已保存方案: %s",   "Profile saved: %s" },
    profileLoaded   = { "已加载方案: %s，可自由修改",   "Loaded: %s, modify freely" },
    profileDeleted  = { "已删除方案: %s",   "Profile deleted: %s" },
    profileNoName   = { "请输入方案名称",   "Enter a profile name" },
    profileNone     = { "无已保存方案",     "No saved profiles" },

    -- 导入导出
    importExport    = { "导入/导出",        "Import / Export" },
    exportBtn       = { "导出当前配置",     "Export Current Config" },
    importBtn       = { "导入为方案",       "Import as Profile" },
    exportHint      = { "复制下方字符串",   "Copy the string below" },
    importName      = { "方案名称",         "Profile Name" },
    importHint      = { "粘贴配置字符串",   "Paste config string" },
    importSuccess   = { "已导入方案: %s",   "Imported profile: %s" },
